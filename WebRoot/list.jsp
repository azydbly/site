...
<head>
<title>版本日志 </title>
<link rel="stylesheet" href="${ctxsty}/common/bootstrap/css/bootstrap.min.css" />
<link rel="stylesheet" href="${ctxsty}/common/font-awesome/css/font-awesome.min.css" />
<link rel="stylesheet" href="${ctxsty}/cms/css/animate.css" />
<link rel="stylesheet" href="${ctxsty}/cms/css/style.css" />

<!-- 全局js -->
<script src="${ctxsty}/common/jquery/jquery-3.2.0.min.js"></script>
<script src="${ctxsty}/common/bootstrap/js/bootstrap.min.js"></script>
<script src="${ctxsty}/common/slimscroll/jquery.slimscroll.min.js"></script>
<!-- 自定义js -->
<script src="${ctxsty}/cms/js/contabs.js"></script>
<script src="${ctxsty}/cms/js/content.js"></script>
...
<myfooter> 
<script src="${ctxsty}/static/yp/js/systemVersionList.js"></script> 
</myfooter>
</body>
</html>