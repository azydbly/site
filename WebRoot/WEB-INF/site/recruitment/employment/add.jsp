...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data" >
		...
		<input type="hidden" name="resumeStatus" value="5" />
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<c:if test="${resumeManage.urlFile != '' && resumeManage.urlFile != null }">
					...
					<a title="下载简历" href="download.action?url=${resumeManage.url }&urlFile=${resumeManage.urlFile}" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe641;</i>下载简历</a>
				</c:if>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendPersonFirst" value="${resumeManage.recommendPersonFirst  }" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>一面面试时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendDateFirst" value="<fmt:formatDate value='${resumeManage.recommendDateFirst }' pattern='yyyy-MM-dd'/>" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>一面面试评价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="input-text textarea" readonly name="recommendDescribeFirst">${resumeManage.recommendDescribeFirst }</textarea>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>二面面试人：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendPersonSecond" value="${resumeManage.recommendPersonSecond  }" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>二面面试时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendDateSecond" value="<fmt:formatDate value='${resumeManage.recommendDateSecond }' pattern='yyyy-MM-dd'/>" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>二面面试评价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="input-text textarea" readonly name="recommendDescribeFirst">${resumeManage.recommendDescribeSecond }</textarea>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>三面面试人：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendPersonSecond" value="${resumeManage.recommendPersonThird  }" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>三面面试时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendDateThird" value="<fmt:formatDate value='${resumeManage.recommendDateThird }' pattern='yyyy-MM-dd'/>" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>三面面试评价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="input-text textarea" readonly name="recommendDescribeThird">${resumeManage.recommendDescribeThird }</textarea>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>录用决议：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="input-text textarea" name="decide"></textarea>
			</div>
		</div>
		<div class="row cl">
