...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data" >
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>面试时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendPersonSecond" value="${sessionScope.employee.userName  }" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>面试时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly name="recommendDateThird" value="<fmt:formatDate value='${resumeManageDate }' pattern='yyyy-MM-dd'/>" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>三面面试评价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="input-text textarea" name="recommendDescribeThird">${resumeManage.recommendDescribeThird }</textarea>
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "saveInterview.action?save=3",
				data: $(form).serialize(),
				dataType: "json",
