...
<head>
<title>杂七杂八</title>
<link rel="stylesheet" type="text/css" href="${ctxsty}/static/yp/mixed/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="${ctxsty}/static/yp/mixed/css/iconfont.min.css" />
 <link rel="stylesheet" type="text/css" href="${ctxsty}/static/yp/css/style.css" />
<style type="text/css">
    ...
    <div class="wap-container">
        <div id="slider-3">
            <div class="slider">
                <div class="bd" style="height: 400px">
                    <ul>
                        <li>
                            <a><img src="${ctxsty}/static/yp/mixed/images/banner1.jpg"></a>
                        </li>
                        <li>
                            <a><img src="${ctxsty}/static/yp/mixed/images/banner2.jpg"></a>
                        </li>
                        <li>
                            <a><img src="${ctxsty}/static/yp/mixed/images/banner3.jpg"></a>
                        </li>
                    </ul>
                </div>
                <ol class="hd cl dots">
        ...
        <div class="container ui-sortable">
                ...
                <div class="panel-body">
                    <table class="table table-border table-bordered table-striped table-responsive mt-20">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-default radius">默认</a></td>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary radius">主要</a></td>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-secondary radius">次要</a></td>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-success radius">成功</a></td>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-warning radius">警告</a></td>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-danger radius">危险</a></td>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-link radius">链接</a></td>
            ...
            <div class="panel panel-default mt-20">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <img src="${ctxsty}/static/yp/mixed/images/ucnter/avatar-default.jpg" class="avatar radius size-MINI">
                        <img src="${ctxsty}/static/yp/mixed/images/ucnter/avatar-default.jpg" class="avatar radius size-S">
                        <img src="${ctxsty}/static/yp/mixed/images/ucnter/avatar-default.jpg" class="avatar radius size-M">
                        <img src="${ctxsty}/static/yp/mixed/images/ucnter/avatar-default.jpg" class="avatar radius size-L">
                        <img src="${ctxsty}/static/yp/mixed/images/ucnter/avatar-default.jpg" class="avatar radius size-XL">
                    </div>
        ...
        <footer class="footer mt-20">
            <div class="container">
                ...
                <p>Copyright &copy;2013-2017 H-ui.net All Rights Reserved. <br></p>
            </div>
        </footer>
    </div>
</div>
...
<script type="text/javascript" src="${ctxsty}/static/yp/mixed/js/jquery.min.js"></script>
<script type="text/javascript" src="${ctxsty}/static/yp/mixed/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="${ctxsty}/static/yp/mixed/js/H-ui.js"></script>
<script type="text/javascript" src="${ctxsty}/static/h-ui.admin/js/H-ui.admin.js"></script>
<script type="text/javascript" src="${ctxsty}/static/yp/mixed/js/jquery.SuperSlide.min.js"></script>
<script type="text/javascript" src="${ctxsty}/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
<script type="text/javascript" src="${ctxsty}/lib/jquery.validation/1.14.0/validate-methods.js"></script>
<script type="text/javascript" src="${ctxsty}/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script>
    //弹窗
    function modaldemo(){
    ...
    $(function(){
        ...
        $("#star-1").raty({
            ...
            path: '${ctxsty}/static/yp/mixed/images/star',//可以是相对路径
